            <table class="table table-hover table-striped table-bordered">
				...
				<thead>
					<tr>
						...
						<th class="text-center">No. of Services Rendered</th>
				...
				<tbody>
					...
					$sql = "SELECT DATE_FORMAT(report_date, '%M, %Y') as report_date,COUNT(DISTINCT service_id) as services, SUM(price) as total FROM (
            ...
            <div class="d-flex w-100">
                ...
                <div class="col-8 text-center">
                    <div style="line-height:1em">
                        ...
                        <h3 class="text-center mb-0"><b>YEARLY SERVICES INCOME REPORT</b></h3>
