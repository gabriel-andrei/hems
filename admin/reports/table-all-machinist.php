<table class="table table-hover table-striped table-bordered">
				...
				<tbody>
					<?php 
                    $sql = "SELECT mechanic_id, NAME, COUNT(DISTINCT id) AS transactions, SUM(amount) AS total 
                    FROM (
                        SELECT tl.id, tl.mechanic_id, CONCAT(m.firstname, ' ', LEFT(m.middlename,1), ', ', m.lastname) name, tl.date_created 
            ...
            <div class="d-flex w-100">
                ...
                <div class="col-8 text-center">
                    <div style="line-height:1em">
                        ...
                        <h3 class="text-center mb-0"><b>MACHINIST REPORT</b></h3>
