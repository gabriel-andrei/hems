...
<div class="container-fluid">
	<form action="" id="service-form">
		...
		<div class="form-group">
			...
			<input type="text" oninput="numbersOnly(this)" name="price" id="price" class="form-control form-control-sm rounded-0 text-left" value="<?php echo isset($price) ? $price : ''; ?>"  readonly/>
		</div>
			<!--
		<div class="form-group">
