...
<?php require_once('inc/header.php') ?>
    ...
    <?php endif;?>      
     <?php $page = isset($_GET['page']) ? $_GET['page'] : 'home';  ?>
      ...
      <div class="content-wrapper pt-3" style="min-height: 567.854px;">
        ...
        <!-- /.content -->
  <div class="modal fade" id="notif_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default border btn-md rounded-pill" data-dismiss="modal">Close</button>
      </div>
      </div>
    </div>
  </div>
  <div class="modal fade" id="confirm_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary border btn-md rounded-pill" id='confirm' onclick="">Continue</button>
        <button type="button" class="btn btn-default border btn-md rounded-pill" data-dismiss="modal">Close</button>
      </div>
      </div>
    </div>
