...
<div class="container-fluid">
	<form action="" id="product-form">
		...
		<div class="row">
			...
			<div class=""><h3 class="text-black text-right"> <b id="amount"><?= isset($balance) ? format_num($balance, 2) : "0.00" ?></b></h4></div>
        </div>
		<hr>
		<div class="row">
		...
		<input type="hidden" name="balance" id="balance" class="form-control " value="<?php echo isset($balance) ? $balance : '' ?>"/>
		...
		<div class="row">
			...
			<div class="form-group col-6">
				...
				<?php if($amount!=$balance): ?>
					<input type="number" oninput="numbersOnly(this)" name="total_amount" id="total_amount" class="form-control form-control-sm rounded-0 text-left" max="<?=$amount?>" value="<?php echo isset($price) ? $price : ''; ?>"  readonly/>
				
				<?php else: ?>
				<input type="number" oninput="numbersOnly(this)" name="total_amount" id="total_amount" class="form-control form-control-sm rounded-0 text-left" max="<?=$amount?>" value="<?php echo isset($price) ? $price : ''; ?>"  required/>
				<?php endif; ?>
