	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			...
			<!-- <div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-blue new_department" href="javascript:void(0)"><i class="fa fa-plus"></i> Add New</a>
			</div>>>>>>>>>> -->
		</div> 
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">Login Page Cover</label>
				<div class="custom-file">
